...
function mfgigcal_CalendarNav($show_title = true) {
	...
	if ($ytd) {
		...
		$mfgigcal_nav .= "<div id=\"cal_nav\"><a href=\"" . $reset_link . "\">" . __('Prossimi', 'mfgigcal') . "</a> | " . __('Archiviati', 'mfgigcal') . ": ";
	}
	else if ($event_id) {
		if ($show_title) {
		...
		$mfgigcal_nav .= "<div id=\"cal_nav\"><strong>" . __('Prossimi', 'mfgigcal') . "</strong> | " . __('Archiviati', 'mfgigcal') . ": ";
	}
